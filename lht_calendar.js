...
function daysInMonth(calDate) {
		...
		var dayCount = [31,28,31,30,31,30,31,31,30,30,31,30,31];
		
		// Extract 4 digit year and month value
		var thisYear = calDate.getFullYear();
		var thisMonth = calDate.getMonth();
		
		// Revise the dyas in February for leap years
		if (thisYear % 4 === 0) {
		...
		// Reurn the number of days for current month
